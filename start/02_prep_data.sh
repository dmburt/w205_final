...
wait && python convert_ntl_rx.py /data/final/data/PartD_Prescriber_PUF_Drug_Ntl_13.csv
cp /data/final/data/PartD_Prescriber_PUF_Drug_Ntl_13.csv /data/final/data/import/prescription-national.csv
